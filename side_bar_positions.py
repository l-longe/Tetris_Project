...
class Side_Bar_Positions:
    ...
    score_text = ui_constants.get_text_surface("SCORE")
    """ The score label in the sidebar. """

    level_text = ui_constants.get_text_surface("LEVEL")
    """ The level label in the sidebar. """

    goal_text = ui_constants.get_text_surface("GOAL")
